...
class ApiCoreController extends CoreControllerPageEditController
{
    ...
    {
        throw new CoreExtensionException('É necessário sobrescrever o método "getExpectedOperationsForResources()" de ApiCoreController.');
    }
    ...
    {
        throw new CoreExtensionException('The method \'Gerar\' must be overwritten!');
    }
