...
abstract class CoreControllerPageEditController extends Cadastro implements CoreControllerPageValidatableInterface
{
     ...
     * da chamada ao construtor de Cadastro().
     */
     ...
     * a chamada ao construtor de Cadastro().
     */
    ...
    /**
     * @see CoreControllerPageValidatableInterface::getValidators()
     */
     ...
     *@see     Cadastro::Inicializar()
     *
     * @see    Cadastro::RenderHTML()
     */
