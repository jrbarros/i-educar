...
class Pessoa extends Base
{
    ...
    protected function validaParametros()
    {
        ...
        if ($numeroAlunos > 1) {
            throw new CoreExtensionException('Não é permitido unificar mais de uma Pessoa vinculada com alunos. Efetue primeiro a unificação de alunos e tente novamente.');
        }
    }
}
