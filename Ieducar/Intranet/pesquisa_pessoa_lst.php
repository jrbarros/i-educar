...
/**
 * Os parâmetros passados para esta página de listagem devem estar dentro da classe ParametrosPesquisas.php
 *
...
require_once('Source/pessoa/Pessoa.php');
