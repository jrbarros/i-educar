...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_pre_requisito)) {
            $obj = new PreRequisito($this->cod_pre_requisito);
...
//      $this->campoTexto( "tabela", "Tabela", $this->tabela, 30, 255, true );
    ...
    public function Novo()
    {
        ...
        $obj = new PreRequisito($this->cod_pre_requisito, $this->pessoa_logada, $this->pessoa_logada, $this->schema_, $this->tabela, $this->nome, $this->sql, $this->data_cadastro, $this->data_exclusao, $this->ativo);
    ...
    public function Excluir()
    {
        ...
        $obj = new PreRequisito($this->cod_pre_requisito, $this->pessoa_logada, $this->pessoa_logada, $this->schema_, $this->tabela, $this->nome, $this->sql, $this->data_cadastro, $this->data_exclusao, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
