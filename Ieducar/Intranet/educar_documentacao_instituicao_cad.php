...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
        ...
        $this->campoArquivo('documento', 'Documentação padrão', $this->documento, 40, Utils::toLatin1('<span id=\'aviso_formato\'>São aceitos apenas arquivos no formato PDF com até 2MB.</span>', ['escape' => false]));
