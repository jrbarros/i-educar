...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
        ...
        $enturmacao = new MatriculaTurma($this->ref_cod_matricula);
        ...
        $matricula = new Matricula($this->ref_cod_matricula);
        $matricula = $matricula->detalhe();

        $instituicao = new Instituicao($matricula['ref_cod_instituicao']);
        $instituicao = $instituicao->detalhe();

        $escola = new Escola($matricula['ref_ref_cod_escola']);
