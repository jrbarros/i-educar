...
class indice extends clsCadastro
{
   ...
   */
    ...
    /**
     * Implementação do método Cadastro::Inicializar()
     *
     * @see Ieducar/Intranet/Source/Cadastro#Inicializar()
     */
    ...
    /**
     * Implementação do método Cadastro::Gerar()
     *
     * @see Ieducar/Intranet/Source/Cadastro#Gerar()
     */
        ...
        if ($det_servidor) {
          ...
          // Passa todos os valores obtidos no registro para atributos do objeto
                    foreach ($lista as $campo => $val) {
                        ...
                        $objTemp = new Serie($val['ref_cod_serie']);
                    ...
                    if ($this->alocacao_array) {
                        ...
                        foreach ($this->alocacao_array as $key => $alocacao) {
                            ...
                            $obj_escola    = new Escola($alocacao['ref_cod_escola']);
            ...
            if (is_array($_POST['ref_cod_servidor_substituto'])) {
                ...
                foreach ($_POST['ref_cod_servidor_substituto'] as $key => $valor) {
                    ...
                    if (is_numeric($ref_cod_servidor_substituto) && is_numeric($ref_cod_escola) &&
                        ...
                        $obj_horario = new QuadroHorarioHorarios(
    ...
    /**
     * Implementação do método Cadastro::Excluir()
     *
     * @see Ieducar/Intranet/Source/Cadastro#Excluir()
     */
