...
class indice extends clsCadastro
{
    ...
    {
        $obj = new TransferenciaTipo(null, null, $this->pessoa_logada, $this->nm_tipo, $this->desc_tipo, null, null, 1, $this->ref_cod_instituicao);
    ...
    {
        $obj = new TransferenciaTipo($this->cod_transferencia_tipo, $this->pessoa_logada, null, $this->nm_tipo, $this->desc_tipo, null, null, 1, $this->ref_cod_instituicao);
        $editou = $obj->edita();
        if ($editou) {
    ...
    {
        $obj = new TransferenciaTipo($this->cod_transferencia_tipo, $this->pessoa_logada, null, null, null, null, null, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
