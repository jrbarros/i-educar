...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->ref_ano) && is_numeric($this->ref_ref_cod_escola)) {
            $obj = new EscolaAnoLetivo($this->ref_ref_cod_escola, $this->ref_ano);
