...
require_once 'include/pessoa/CadastroRaca.php';

require_once 'include/pessoa/CadastroFisicaRaca.php';
...
require_once 'include/modules/Motorista.php';
...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
        ...
        $this->cod_pessoa_fj;
        $objPessoa = new PessoaFisica($this->cod_pessoa_fj);
        $db = new Banco();
    ...
    public function Excluir()
    {
        ...
        $pessoaFisica = new PessoaFisica($idPes);
