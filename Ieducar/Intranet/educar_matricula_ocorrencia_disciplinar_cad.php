...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->ref_cod_matricula) &&
            ...
            $obj = new MatriculaOcorrenciaDisciplinar($this->ref_cod_matricula, $this->ref_cod_tipo_ocorrencia_disciplinar, $this->sequencial);
    ...
    public function Gerar()
    {
        ...
        $objTemp = new TipoOcorrenciaDisciplinar();
    ...
    public function Novo()
    {
        ...
        $obj_ref_cod_matricula = new Matricula($this->ref_cod_matricula);
        $detalhe_mat = $obj_ref_cod_matricula->detalhe();
        $this->ref_cod_instituicao = $detalhe_mat['ref_cod_instituicao'];

        $obj = new MatriculaOcorrenciaDisciplinar($this->ref_cod_matricula, $this->ref_cod_tipo_ocorrencia_disciplinar, null, $this->pessoa_logada, $this->pessoa_logada, $this->observacao, $this->getDataHoraCadastro(), $this->data_exclusao, $this->ativo, $this->visivel_pais);
    ...
    public function Editar()
    {
        ...
        $obj = new MatriculaOcorrenciaDisciplinar($this->ref_cod_matricula, $this->ref_cod_tipo_ocorrencia_disciplinar, $this->sequencial, $this->pessoa_logada, $this->pessoa_logada, $this->observacao, $this->getDataHoraCadastro(), $this->data_exclusao, $this->ativo, $this->visivel_pais);
    ...
    {
        $tmp_obj = new ConfiguracoesGerais($this->ref_cod_instituicao);
        $instituicao = $tmp_obj->detalhe();

        $obj_tmp = new Matricula($this->ref_cod_matricula);
        $det_tmp = $obj_tmp->detalhe();
        $cod_aluno = $det_tmp['ref_cod_aluno'];

        $cod_escola = $det_tmp['ref_ref_cod_escola'];

        $obj_tmp = new TipoOcorrenciaDisciplinar($this->ref_cod_tipo_ocorrencia_disciplinar);
        $det_tmp = $obj_tmp->detalhe();
