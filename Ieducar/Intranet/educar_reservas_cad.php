...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_reserva)) {
            $obj = new Reservas($this->cod_reserva);
        ...
        if ($this->titulo_obra) {
            ...
            if (is_array($lst_exemplar) && count($lst_exemplar)) {
                ...
                if (!$reservou) {
                    ...
                    $reservas = [];
                    foreach ($lst_exemplar as $exemplar) {
                        $obj_situacao = new Situacao($exemplar['ref_cod_situacao']);
...
//      echo "data_prevista_disponivel 5: ".$data_prevista_disponivel."<br>";die;
        ...
        $obj = new Reservas(null, null, $this->pessoa_logada, $this->ref_cod_cliente, null, $data_prevista_disponivel, null, $this->ref_cod_exemplar, 1);
