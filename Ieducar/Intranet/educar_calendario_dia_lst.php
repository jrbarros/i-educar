...
class indice extends clsListagem
{
    ...
    public function Gerar()
    {
        ...
        $obj_calendario_dia = new CalendarioDia();
        ...
        if (is_array($lista) && count($lista)) {
            foreach ($lista as $registro) {
                $obj_ref_cod_calendario_dia_motivo = new CalendarioDiaMotivo($registro['ref_cod_calendario_dia_motivo']);
                ...
                $obj_ref_cod_calendario_ano_letivo = new CalendarioAnoLetivo($registro['ref_cod_calendario_ano_letivo']);
