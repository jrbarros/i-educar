...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->ref_cod_aluno) && is_numeric($this->sequencial)) {
            $obj = new HistoricoEscolar($this->ref_cod_aluno, $this->sequencial);
    ...
    public function Gerar()
    {
        if (isset($_GET['ref_cod_aluno'], $_GET['sequencial'])) {
            $objCodNomeEscola = new HistoricoEscolar($_GET['ref_cod_aluno'], $_GET['sequencial']);
        ...
        $obj_nivel = new Usuario($this->pessoa_logada);
        ...
        if ($nivel_usuario['ref_cod_tipo_usuario'] == 1) {
            ...
            $obj_instituicao = new Instituicao($nivel_usuario['ref_cod_instituicao']);
        ...
        if ($cadastrou) {
            ...
            if ($this->nm_disciplina) {
                ...
                foreach ($this->nm_disciplina as $key => $disciplina) {
                    ...
                    $obj = new HistoricoDisciplinas($sequencial, $this->ref_cod_aluno, $this->sequencial, $disciplina, $this->nota[$key], $this->faltas[$key], $this->ordenamento[$key], $this->carga_horaria_disciplina[$key], $this->disciplinaDependencia[$key] == 'on' ? true : false, $this->tipo_base[$key]);
    ...
    public function Editar()
    {
        ...
        $historicoEscolar = new HistoricoEscolar($this->ref_cod_aluno, $this->sequencial);
        ...
        $obj = new HistoricoEscolar($this->ref_cod_aluno, $this->sequencial, $this->pessoa_logada, null, $this->nm_serie, $this->ano, $this->carga_horaria, $this->dias_letivos, $this->escola, $this->escola_cidade, $this->escola_uf, $this->observacao, $this->aprovado, null, null, 1, $this->faltas_globalizadas, $this->ref_cod_instituicao, 1, $this->extra_curricular, null, $this->frequencia, $this->registro, $this->livro, $this->folha, $this->nm_curso, $this->historico_grade_curso_id, $this->aceleracao, $this->ref_cod_escola, !is_null($this->dependencia), $this->posicao);
        $editou = $obj->edita();
    ...
    public function Excluir()
    {
        ...
        $obj = new HistoricoEscolar($this->ref_cod_aluno, $this->sequencial, $this->pessoa_logada, null, null, null, null, null, null, null, null, null, null, null, null, 0);
    ...
    {
        $obj_instituicao = new Instituicao($instituicao);
