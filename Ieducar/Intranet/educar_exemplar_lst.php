    ...
    public function Gerar()
    {
        ...
        if (is_array($lista) && count($lista)) {
            foreach ($lista as $registro) {
                ...
                $obj_ref_cod_fonte = new Fonte($registro['ref_cod_fonte']);
                $det_ref_cod_fonte = $obj_ref_cod_fonte->detalhe();
                $registro['ref_cod_fonte'] = $det_ref_cod_fonte['nm_fonte'];

                $obj_ref_cod_motivo_baixa = new MotivoBaixa($registro['ref_cod_motivo_baixa']);
                ...
                $obj_ref_cod_tipo = new ExemplarTipo($det_ref_cod_acervo['ref_cod_exemplar_tipo']);
                $det_ref_cod_tipo = $obj_ref_cod_tipo->detalhe();
                $registro['ref_cod_tipo'] = $det_ref_cod_tipo['nm_tipo'];

                $obj_ref_cod_situacao = new Situacao($registro['ref_cod_situacao']);
