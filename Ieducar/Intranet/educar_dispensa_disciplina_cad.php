...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->ref_cod_matricula)) {
            $obj_matricula = new Matricula($this->ref_cod_matricula, null, null, null, null, null, null, null, null, null, 1);
    ...
    public function Gerar()
    {
        ...
        $obj_escola = new Escola($this->ref_cod_escola, null, null, null, null, null, null, null, null, null, 1);
    ...
    public function montaEtapas()
    {
        ...
        $objTurmaModulo      = new TurmaModulo();
        ...
        foreach ($dadosEtapa as $modulo) {
            $checked = '';
            $objDispensaEtapa = new DispensaDisciplinaEtapa($this->cod_dispensa, $modulo['sequencial']);
    ...
    {
        $objetoDispensa = new DispensaDisciplina(
