...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_coffebreak_tipo)) {
            $obj = new CoffeeBreakTipo($this->cod_coffebreak_tipo);
    ...
    public function Novo()
    {
        ...
        $obj = new CoffeeBreakTipo($this->cod_coffebreak_tipo, null, $this->pessoa_logada, $this->nm_tipo, $this->desc_tipo, $this->custo_unitario, null, null, 1);
    ...
    public function Editar()
    {
        ...
        $obj = new CoffeeBreakTipo($this->cod_coffebreak_tipo, $this->pessoa_logada, null, $this->nm_tipo, $this->desc_tipo, $this->custo_unitario, null, null, 1);
        $editou = $obj->edita();
        if ($editou) {
    ...
    {
        $obj = new CoffeeBreakTipo($this->cod_coffebreak_tipo, $this->pessoa_logada, null, $this->nm_tipo, $this->desc_tipo, $this->custo_unitario, null, null, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
