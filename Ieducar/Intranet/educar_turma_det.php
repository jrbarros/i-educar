...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        $obj_ref_cod_turma_tipo = new TurmaTipo(
        ...
        $obj_ref_cod_infra_predio_comodo = new InfraPredioComodo(
        ...
        $obj_cod_instituicao = new Instituicao(
        ...
        if ($registro['multiseriada'] == 1) {
            ...
            $obj_serie_mult = new Serie($registro['ref_ref_cod_serie_mult']);
            ...
            <tr align="center">
              ...
              <td bgcolor="#f5f9fd "><b>Dias Letivos</b></td>
                ...
                foreach ($lst as $valor) {
                    ...
                    $obj_modulo = new Modulo($valor['ref_cod_modulo']);
