...
use iEducarLegacy\Intranet\Source\PmiEducar\AcervoColecao;
...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_acervo_colecao)) {
            $obj = new AcervoColecao($this->cod_acervo_colecao);
            ...
            if ($registro) {
                ...
                $obj_obra = new AcervoColecao($this->cod_acervo_colecao);
    ...
    public function Gerar()
    {
        ...
        if(is_array($lst_pessoa_bib))
        {
            ...
            {
                $obj_biblioteca = new Biblioteca($bib['ref_cod_biblioteca']);
    ...
    public function Novo()
    {
        ...
        $obj = new AcervoColecao($this->cod_acervo_colecao, $this->pessoa_logada, $this->pessoa_logada, $this->nm_colecao, $this->descricao, $this->data_cadastro, $this->data_exclusao, $this->ativo, $this->ref_cod_biblioteca);
    ...
    public function Excluir()
    {
        ...
        $obj = new AcervoColecao($this->cod_acervo_colecao, $this->pessoa_logada, $this->pessoa_logada, $this->nm_colecao, $this->descricao, $this->data_cadastro, $this->data_exclusao, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
