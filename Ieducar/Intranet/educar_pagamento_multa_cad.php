...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->ref_cod_cliente)) {
            $obj_total_divida = new ExemplarEmprestimo();
            ...
            if ($det_cliente) {
                ...
                $obj_divida = new ExemplarEmprestimo(null, null, null, $this->ref_cod_cliente);
    ...
    public function Novo()
    {
        ...
        $obj = new PagamentoMulta(null, $this->pessoa_logada, $this->ref_cod_cliente, $this->valor_pagamento, null, $this->ref_cod_biblioteca);
    ...
    public function Editar()
    {
        ...
        $obj = new PagamentoMulta($this->cod_pagamento_multa, null, $this->ref_cod_cliente, $this->valor_pago, null, $this->ref_cod_biblioteca);
        $editou = $obj->edita();
        if ($editou) {
