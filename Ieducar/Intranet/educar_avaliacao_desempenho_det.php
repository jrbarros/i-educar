...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        $tmp_obj = new AvaliacaoDesempenho($this->sequencial, $this->ref_cod_servidor, $this->ref_ref_cod_instituicao);
        ...
        $obj_instituicao = new Instituicao($registro['ref_ref_cod_instituicao']);
