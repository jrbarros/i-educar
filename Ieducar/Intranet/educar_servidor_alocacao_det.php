...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        $tmp_obj = new ServidorAlocacao($this->cod_servidor_alocacao, $this->ref_cod_instituicao);
        ...
        //Escola
        $escola = new Escola($registro['ref_cod_escola']);
        ...
        if ($this->ref_cod_servidor_funcao) {
            $funcaoServidor = new ServidorFuncao(null, null, null, null, $this->ref_cod_servidor_funcao);
            $funcaoServidor = $funcaoServidor->detalhe();

            $funcao = new Funcao($funcaoServidor['ref_cod_funcao']);
