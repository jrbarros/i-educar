...
class AuditoriaNota
{
    public const OPERACAO_INCLUSAO = 1;
    public const OPERACAO_ALTERACAO = 2;
    public const OPERACAO_EXCLUSAO = 3;
    ...
    private function getInfosMatricula($notaAlunoId)
    {
        ...
        $objMatricula = new Matricula($matriculaId);
    ...
    {
        $objInstituicao = new Instituicao($instituicaoId);
