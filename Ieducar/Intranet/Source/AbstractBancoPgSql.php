...
abstract class AbstractBancoPgSql
{
    /**
     ...
     *
     * @see AbstractBancoPgSql#Consulta()
     *
     * @var bool
     */
     ...
     * Construtor.
     *
     * @link http://svn.softwarepublico.gov.br/trac/ieducar/ticket/58 Remover parâmetro não utilizado do construtor de Banco (ticket 58)
     */
    public function __construct($options)
    {
        ...
        if (is_array($options) && array_key_exists('fetchMode', $options)) {
     ...
     * @param int $fetchMode
     *
     * @return AbstractBancoPgSql Provê interface fluída
     */
    ...
    /**
     * @see AbstractBancoPgSql#InsertId($str_sequencia = FALSE)
     */
    public function UltimoID($str_sequencia = false)
    {
    ...
    /**
     * @see AbstractBancoPgSql#numLinhas()
     */
    ...
    /**
     * @see AbstractBancoPgSql#numCampos()
     */
    ...
    /**
     * @see AbstractBancoPgSql#UnicoCampo()
     */
     ...
     *                       em caso de sucesso.
     */
    public function execPreparedQuery($query, $params = [])
    {
        try {
            $errorMsgs = '';
