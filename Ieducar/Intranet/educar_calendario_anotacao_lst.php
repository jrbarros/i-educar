...
class indice extends clsListagem
{
    ...
    public function Gerar()
    {
        ...
        if ($this->ref_cod_calendario_ano_letivo && $this->ano && $this->mes && $this->dia) {
            $obj_calendario = new CalendarioAnoLetivo($this->ref_cod_calendario_ano_letivo);
        ...
        /*$obj_calendario_anotacao = new CalendarioAnotacao();
        ...
        $obj_calendario_anotacao_dia = new CalendarioDiaAnotacao();
        ...
        if (is_array($lista) && count($lista)) {
            foreach ($lista as $registro) {
                $obj_calendario_anotacao = new CalendarioAnotacao($registro['ref_cod_calendario_anotacao'], null, null, null, null, null, null, 1);
