...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_funcao)) {
            $obj = new Funcao($this->cod_funcao);
    ...
    public function Novo()
    {
        ...
        $obj = new Funcao(null, null, $this->pessoa_logada, $this->nm_funcao, $this->abreviatura, $this->professor, null, null, 1, $this->ref_cod_instituicao);
    ...
    public function Editar()
    {
        ...
        $obj = new Funcao($this->cod_funcao, $this->pessoa_logada, null, $this->nm_funcao, $this->abreviatura, $this->professor, null, null, 1, $this->ref_cod_instituicao);
        $editou = $obj->edita();
        if ($editou) {
    ...
    public function Excluir()
    {
        ...
        $obj = new Funcao($this->cod_funcao, $this->pessoa_logada, null, null, null, null, null, null, 0, $this->ref_cod_instituicao);
