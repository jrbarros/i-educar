...
//require_once ("Source/juris/jurisGeral.inc.php");
...
class indice extends clsCadastro
{
    ...
    public function RenderHTML()
    {
        ...
        if ($_REQUEST['cod_agenda']) {
            ...
            $objAgenda = new Agenda($this->editor, false, $_REQUEST['cod_agenda']);
        } else {
            $objAgenda = new Agenda($this->editor, $this->editor, false);
