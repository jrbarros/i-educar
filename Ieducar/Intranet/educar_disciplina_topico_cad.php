...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_disciplina_topico)) {
            $obj = new DisciplinaTopico($this->cod_disciplina_topico);
    ...
    {
        $obj = new DisciplinaTopico(null, null, $this->pessoa_logada, $this->nm_topico, $this->desc_topico);
    ...
    {
        $obj = new DisciplinaTopico($this->cod_disciplina_topico, $this->pessoa_logada, null, $this->nm_topico, $this->desc_topico, null, null, 1);
        $editou = $obj->edita();
        if ($editou) {
    ...
    {
        $obj = new DisciplinaTopico($this->cod_disciplina_topico, $this->pessoa_logada, null, null, null, null, null, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
