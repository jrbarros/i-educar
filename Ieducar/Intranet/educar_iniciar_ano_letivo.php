...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        $obj_ano_letivo = new EscolaAnoLetivo($this->ref_cod_escola, $this->ano, null, null, null, null, null, null);
    ...
    public function iniciarAnoLetivo()
    {
        ...
        $obj_ano_letivo = new EscolaAnoLetivo($this->ref_cod_escola, $this->ano, $this->pessoa_logada, $this->pessoa_logada, 1, null, null, 1);
    ...
    public function finalizarAnoLetivo()
    {
        ...
        $obj_matriculas = new Matricula(null, null, $this->ref_cod_escola, null, $this->pessoa_logada, null, null, null, null, null, 1, $this->ano);
        ...
        $obj_ano_letivo = new EscolaAnoLetivo($this->ref_cod_escola, $this->ano, $this->pessoa_logada, $this->pessoa_logada, 2, null, null, 1);
        if (!$obj_ano_letivo->edita()) {
            echo "<script>
                    alert('Erro ao finalizar o ano letivo!');
                    window.location = 'educar_escola_det.php?cod_escola={$this->ref_cod_escola}#ano_letivo';
