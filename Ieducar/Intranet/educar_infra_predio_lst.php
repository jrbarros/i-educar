...
class indice extends clsListagem
{
    ...
    public function Gerar()
    {
        ...
        $obj_escola = new Escola($this->ref_cod_escola, null, null, ref_cod_instituicao, null, null, null, null, null, null, 1);
        ...
        if (is_array($lista) && count($lista)) {
            foreach ($lista as $registro) {
                ...
                $obj_ref_cod_intituicao = new Instituicao($registro['ref_cod_instituicao']);
