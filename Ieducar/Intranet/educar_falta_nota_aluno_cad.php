...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
        ...
        $obj_matricula = new Matricula($this->ref_cod_matricula);
        ...
        $obj_curso = new Curso($this->ref_cod_curso);
        $det_curso = $obj_curso->detalhe();
        ...
        $obj_tipo_avaliacao = new TipoAvaliacao($this->ref_cod_tipo_avaliacao);
        ...
        $obj_avaliacao_valores = new TipoAvaliacaoValores();
            ...
            if (($this->qtd_modulos < $this->modulo) && !$this->conceitual) {
                ...
                foreach ($aluno_exame_disciplina as $key => $disciplina) {
                    if (!$dispensa[$disciplina] && !$com_nota[$disciplina]) {
                        ...
                        $obj_disciplina = new Disciplina($disciplina);
                    ...
                    if ($this->falta_ch_globalizada) {
                        ...
                        foreach ($lst_disciplinas as $key => $disciplinas) {
                            if (!$dispensa[$disciplinas['ref_cod_disciplina']] && !$com_nota[$disciplinas['ref_cod_disciplina']]) {
                                $obj_disciplina = new Disciplina($disciplinas['ref_cod_disciplina']);
                                $det_disciplina = $obj_disciplina->detalhe();
                                $nm_disciplina = $det_disciplina['nm_disciplina'];
...
//                      $this->campoLista( "disciplina_modulo[{$key}][nota]", " Nota Exame", $opcoes_valores, $lst_disciplina[$disciplina]['nota'] );
    ...
    public function Novo()
    {
        ...
        if ($this->ref_ref_cod_serie) {
            ...
            $obj = new Matricula($this->ref_cod_matricula, null, null, null, $this->pessoa_logada, null, null, $aprovado, null, null, null, null, null, $this->modulo+1);
            $editou = $obj->edita();
            ...
            if ($editou) {
                ...
                if ($aprovado == 1 || $aprovado == 2) {
                    ...
                    $obj_escola = new Escola($this->ref_ref_cod_escola);
                    ...
                    $obj = new HistoricoEscolar($this->ref_cod_aluno, null, null, $this->pessoa_logada, $det_serie['nm_serie'], $this->ano_letivo, $carga_horaria_serie, null, $nm_escola, $cidade, $uf, null, $aprovado, null, null, 1, $total_faltas, $this->ref_cod_instituicao, 0, $extra_curricular, $this->ref_cod_matricula);
                    $cadastrou2 = $obj->cadastra();
                    if ($cadastrou2 && !$this->conceitual) {
                        $obj_historico = new HistoricoEscolar();
                        ...
                        foreach ($historico_disciplina as $disciplina => $campo) {
                            ...
                            if (is_array($lst_avaliacao_valores)) {
                                ...
                                $obj = new HistoricoDisciplinas(null, $this->ref_cod_aluno, $sequencial, $nm_disciplina, $nm_nota, $campo[1]);
...
//                      $nota_media_aluno[$disciplina] /= $this->modulo;
            ...
            if ($editou) {
                ...
                if ($aprovado == 1 || $aprovado == 2) {
                    ...
                    $obj_instituicao = new Instituicao($this->ref_cod_instituicao);
                    ...
                    $obj = new HistoricoEscolar($this->ref_cod_aluno, null, null, $this->pessoa_logada, $det_curso['nm_curso'], $this->ano_letivo, $carga_horaria_curso, null, $nm_instituicao, $cidade, $uf, null, $aprovado, null, null, 1, $total_faltas, $this->ref_cod_instituicao, 0, 1, $this->ref_cod_matricula);
                    $cadastrou2 = $obj->cadastra();
                    if ($cadastrou2 && !$this->conceitual) {
                        $obj_historico = new HistoricoEscolar();
                        $sequencial = $obj_historico->getMaxSequencial($this->ref_cod_aluno);
            ...
            if ($total > 0) {
                ...
                if ($ultimo_modulo_matricula < $this->mat_modulo) {
                    if ($this->nota_foi_removida && $this->pessoa_logada==184580) {
                        $obj_hst_escolar = new HistoricoEscolar();
                        ...
                        if (is_array($lst_hst_escolar)) {
                            ...
                            $obj_hd = new HistoricoDisciplinas();
                            ...
                            $obj_hst_escolar = new HistoricoEscolar($this->ref_cod_aluno, $det_hst_escolar['sequencial'], $this->pessoa_logada, null, null, null, null, null, null, null, null, null, null, null, null, 0);
                    ...
                    $obj = new Matricula($this->ref_cod_matricula, null, null, null, $this->pessoa_logada, null, null, 3, null, null, null, null, null, $ultimo_modulo_matricula);
                    $editou = $obj->edita();
                }
...
//              echo "<pre>"; print_r($soma_notas);
            ...
            $obj = new Matricula($this->ref_cod_matricula, null, null, null, $this->pessoa_logada, null, null, $aprovado);
            $editou = $obj->edita();
            //die($aprovado);
            if ($editou) {
                /**
                ...
                /*else */if ($aprovado == 1 || $aprovado == 2) {
                    ...
                    if (is_array($lst_hst_escolar)) {
                        ...
                        $obj = new HistoricoEscolar($this->ref_cod_aluno, $det_hst_escolar['sequencial'], $this->pessoa_logada, null, null, null, null, null, null, $cidade, $uf, null, $aprovado, null, null, 1, $total_faltas, null, null, $extra_curricular);
                        $editou_he = $obj->edita();
                    } else {
                        $obj = new HistoricoEscolar($this->ref_cod_aluno, null, null, $this->pessoa_logada, $det_serie['nm_serie'], $this->ano_letivo, $carga_horaria_serie, null, $nm_escola, $cidade, $uf, null, $aprovado, null, null, 1, $total_faltas, $this->ref_cod_instituicao, 0, $extra_curricular, $this->ref_cod_matricula);
                        ...
                        foreach ($historico_disciplina as $disciplina => $campo) {
                            ...
                            if (is_array($lst_avaliacao_valores)) {
                                ...
                                if (is_array($lst_hd)) {
                                    ...
                                    $obj_hd = new HistoricoDisciplinas($det_hd['sequencial'], $this->ref_cod_aluno, $sequencial, $nm_disciplina, $nm_nota, $campo[1]);
                                    $hst_disciplina = $obj_hd->edita();
                                } else {
                                    $obj_hd = new HistoricoDisciplinas(null, $this->ref_cod_aluno, $sequencial, $nm_disciplina, $nm_nota, $campo[1]);
            ...
            if ($editou) {
                ...
                /*else*/ if ($aprovado == 1 || $aprovado == 2) {
                    ...
                    if (is_array($lst_hst_escolar)) {
                        ...
                        $obj_hst_escolar = new HistoricoEscolar($this->ref_cod_aluno, $det_hst_escolar['sequencial'], $this->pessoa_logada, null, $det_curso['nm_curso'], $this->ano_letivo, $carga_horaria_curso, null, $nm_instituicao, $cidade, $uf, null, $aprovado, null, null, 1, $total_faltas, $this->ref_cod_instituicao, 0, 1, $this->ref_cod_matricula);
                        $editou_he = $obj_hst_escolar->edita();
                    } else {
                        $obj_hst_escolar = new HistoricoEscolar($this->ref_cod_aluno, null, null, $this->pessoa_logada, $det_curso['nm_curso'], $this->ano_letivo, $carga_horaria_curso, null, $nm_instituicao, $cidade, $uf, null, $aprovado, null, null, 1, $total_faltas, $this->ref_cod_instituicao, 0, 1, $this->ref_cod_matricula);
        ...
        if (is_array($this->disciplina_modulo)) {
            foreach ($this->disciplina_modulo as $avaliacao) {
                if (is_numeric($avaliacao['nota'])) {
                    $obj = new NotaAluno(null, $avaliacao['nota'], $this->ref_cod_tipo_avaliacao, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, null, $this->pessoa_logada, null, null, 1, $this->modulo);
                } else {
                    $avaliacao['nota'] = str_replace('.', '', $avaliacao['nota']);
                    $avaliacao['nota'] = str_replace(',', '.', $avaliacao['nota']);

                    $obj = new NotaAluno(null, null, null, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, null, $this->pessoa_logada, null, null, 1, $this->modulo, null, $avaliacao['nota']);
                }
                ...
                if (is_numeric($avaliacao['nota'])) {
                    ...
                    if ($cadastrou && ($this->qtd_modulos >= $this->modulo)) {
                        if (!$this->falta_ch_globalizada && is_numeric($avaliacao['faltas'])) {
                            $obj = new FaltaAluno(null, null, $this->pessoa_logada, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, $avaliacao['faltas'], null, null, 1, $this->modulo);
            ...
            if ($cadastrou && ($this->qtd_modulos >= $this->modulo) && $this->falta_ch_globalizada && is_numeric($this->total_faltas)) {
                $obj = new Faltas($this->ref_cod_matricula, $this->modulo, $this->pessoa_logada, $this->total_faltas);
                if ($obj->existe()) {
    ...
    public function cadastraCNotasFaltas()
    {
        if (is_array($this->disciplina_modulo)) {
            foreach ($this->disciplina_modulo as $avaliacao) {
                if (is_numeric($avaliacao['nota'])) {
                    $obj = new NotaAluno(null, $avaliacao['nota'], $this->ref_cod_tipo_avaliacao, null, null, null, $this->ref_cod_matricula, null, $this->pessoa_logada, null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina']);
                } else {
                    $avaliacao['nota'] = str_replace('.', '', $avaliacao['nota']);
                    $avaliacao['nota'] = str_replace(',', '.', $avaliacao['nota']);

                    $obj = new NotaAluno(null, null, null, null, null, null, $this->ref_cod_matricula, null, $this->pessoa_logada, null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina'], $avaliacao['nota']);
                }
                if (is_numeric($avaliacao['nota'])) {
                    $cadastrou = $obj->cadastra();
                    if ($cadastrou && ($this->qtd_modulos >= $this->modulo)) {
                        if (!$this->falta_ch_globalizada && is_numeric($avaliacao['faltas'])) {
                            $obj = new FaltaAluno(null, null, $this->pessoa_logada, null, null, null, $this->ref_cod_matricula, $avaliacao['faltas'], null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina']);
                            $cadastrou1 = $obj->cadastra();
                            if (!$cadastrou1) {
                                $this->mensagem = 'Cadastro n&atilde;o realizado.<br>';
    ...
    public function editaSNotasFaltas()
    {
        if (is_array($this->disciplina_modulo)) {
            ...
            foreach ($this->disciplina_modulo as $avaliacao) {
                $obj_nota_aluno = new NotaAluno($avaliacao['cod_nota_aluno'], null, null, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, null, null, null, null, 1, $this->modulo);
                $existe_nota = $obj_nota_aluno->existe();

                if ($existe_nota) {
                    if (is_numeric($avaliacao['nota'])) {
                        $obj_nota_aluno = new NotaAluno($avaliacao['cod_nota_aluno'], $avaliacao['nota'], $this->ref_cod_tipo_avaliacao, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, $this->pessoa_logada, null, null, null, 1, $this->modulo);
                    } else {
                        $avaliacao['nota'] = str_replace('.', '', $avaliacao['nota']);
                        $avaliacao['nota'] = str_replace(',', '.', $avaliacao['nota']);

                        $obj_nota_aluno = new NotaAluno($avaliacao['cod_nota_aluno'], null, null, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, $this->pessoa_logada, null, null, null, 1, $this->modulo, null, $avaliacao['nota']);
                    }
                    if ($avaliacao['nota'] == -1) {
                    ...
                    if (is_numeric($avaliacao['nota'])) {
                        $obj_nota_aluno = new NotaAluno(null, $avaliacao['nota'], $this->ref_cod_tipo_avaliacao, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, null, $this->pessoa_logada, null, null, 1, $this->modulo);
                    } else {
                        $avaliacao['nota'] = str_replace('.', '', $avaliacao['nota']);
                        $avaliacao['nota'] = str_replace(',', '.', $avaliacao['nota']);

                        $obj_nota_aluno = new NotaAluno(null, null, null, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, null, $this->pessoa_logada, null, null, 1, $this->modulo, null, $avaliacao['nota']);
                    }
                    /**
                ...
                if (($this->qtd_modulos >= $this->modulo) && !$this->falta_ch_globalizada && is_numeric($avaliacao['faltas'])) {
                    $obj_falta_aluno = new FaltaAluno($avaliacao['cod_falta_aluno'], null, null, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, null, null, null, 1, $this->modulo);
                    $existe_falta = $obj_falta_aluno->existe();
                    if ($existe_falta) {
                        $obj_falta_aluno = new FaltaAluno($avaliacao['cod_falta_aluno'], $this->pessoa_logada, null, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, $avaliacao['faltas'], null, null, 1, $this->modulo);
                        ...
                        if (is_numeric($avaliacao['faltas'])) {
                            $obj_falta_aluno = new FaltaAluno(null, null, $this->pessoa_logada, $this->ref_ref_cod_serie, $this->ref_ref_cod_escola, $avaliacao['ref_cod_disciplina'], $this->ref_cod_matricula, $avaliacao['faltas'], null, null, 1, $this->modulo);
            ...
            if (($this->qtd_modulos >= $this->modulo) && $this->falta_ch_globalizada && is_numeric($this->total_faltas)) {
                $obj_faltas = new Faltas($this->ref_cod_matricula, $this->modulo);
                $existe_faltas = $obj_faltas->existe();
                if ($existe_faltas) {
                    $obj_faltas = new Faltas($this->ref_cod_matricula, $this->modulo, null, $this->total_faltas);
                    ...
                    $obj_faltas = new Faltas($this->ref_cod_matricula, $this->modulo, $this->pessoa_logada, $this->total_faltas);
    ...
    public function editaCNotasFaltas()
    {
        if (is_array($this->disciplina_modulo)) {
            foreach ($this->disciplina_modulo as $avaliacao) {
                $obj_nota_aluno = new NotaAluno($avaliacao['cod_nota_aluno'], null, null, null, null, null, $this->ref_cod_matricula, null, null, null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina']);
                $existe_nota = $obj_nota_aluno->existe();
                if ($existe_nota) {
                    if (is_numeric($avaliacao['nota'])) {
                        $obj_nota_aluno = new NotaAluno($avaliacao['cod_nota_aluno'], $avaliacao['nota'], $this->ref_cod_tipo_avaliacao, null, null, null, $this->ref_cod_matricula, $this->pessoa_logada, null, null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina']);
                    } else {
                        $avaliacao['nota'] = str_replace('.', '', $avaliacao['nota']);
                        $avaliacao['nota'] = str_replace(',', '.', $avaliacao['nota']);

                        $obj_nota_aluno = new NotaAluno($avaliacao['cod_nota_aluno'], null, null, null, null, null, $this->ref_cod_matricula, $this->pessoa_logada, null, null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina'], $avaliacao['nota']);
                    }
                    if ($avaliacao['nota'] == -1) {
                        $editou_nota = $obj_nota_aluno->excluir();
                    } else {
                    ...
                    if (is_numeric($avaliacao['nota'])) {
                        $obj_nota_aluno = new NotaAluno(null, $avaliacao['nota'], $this->ref_cod_tipo_avaliacao, null, null, null, $this->ref_cod_matricula, null, $this->pessoa_logada, null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina']);
                    } else {
                        $avaliacao['nota'] = str_replace('.', '', $avaliacao['nota']);
                        $avaliacao['nota'] = str_replace(',', '.', $avaliacao['nota']);
                        $obj_nota_aluno = new NotaAluno(null, null, null, null, null, null, $this->ref_cod_matricula, null, $this->pessoa_logada, null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina'], $avaliacao['nota']);
                    }
                    if (is_numeric($avaliacao['nota'])) {
                        $cadastrou_nota = $obj_nota_aluno->cadastra();
                        if (!$cadastrou_nota) {
                ...
                if (($this->qtd_modulos >= $this->modulo) && !$this->falta_ch_globalizada && is_numeric($avaliacao['faltas'])) {
                    $obj_falta_aluno = new FaltaAluno($avaliacao['cod_falta_aluno'], null, null, null, null, null, $this->ref_cod_matricula, null, null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina']);
                    $existe_falta = $obj_falta_aluno->existe();
                    if ($existe_falta) {
                        $obj_falta_aluno = new FaltaAluno($avaliacao['cod_falta_aluno'], $this->pessoa_logada, null, null, null, null, $this->ref_cod_matricula, $avaliacao['faltas'], null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina']);
                        $editou_falta = $obj_falta_aluno->edita();
                        if (!$editou_falta) {
                            $this->mensagem = 'Edi&ccedil;&atilde;o n&atilde;o realizada.<br>';
                        ...
                        $obj_falta_aluno = new FaltaAluno(null, null, $this->pessoa_logada, null, null, null, $this->ref_cod_matricula, $avaliacao['faltas'], null, null, 1, $this->modulo, $avaliacao['ref_cod_disciplina']);
                        $cadastrou_falta = $obj_falta_aluno->cadastra();
                        if (!$cadastrou_falta) {
                            $this->mensagem = 'Cadastro n&atilde;o realizado.<br>';
