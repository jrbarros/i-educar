...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_turma)) {
            $obj_turma = new Turma($this->cod_turma);
            $registro = $obj_turma->detalhe();
            $obj_esc = new Escola($registro['ref_ref_cod_escola']);
            $det_esc = $obj_esc->detalhe();
            $obj_ser = new Serie($registro['ref_ref_cod_serie']);
            ...
            if ($registro) {
                ...
                $objTurma = new Turma($this->cod_turma);
    ...
    public function Gerar()
    {
        ...
        if (!isset($this->cod_turma)) {
            ...
            if (is_numeric($this->cod_turma)) {
                $obj_matriculas_turma = new MatriculaTurma();
    ...
    public function Novo()
    {
        ...
        $turma = new Turma($this->cod_turma);
        $turma = $turma->detalhe();
    ...
    {
        $turmaDetalhe = new Turma($this->cod_turma);
    ...
    public function cadastraModulo($modulo)
    {
        ...
        $objModulo = new TurmaModulo($this->cod_turma);
