...
class DiarioApiController extends ApiCoreController
{
    ...
    protected function validatesCanChangeDiarioForAno()
    {
        ...
        $objBloqueioAnoLetivo = new BloqueioAnoLetivo($this->getRequest()->instituicao_id, $this->getRequest()->ano);
    ...
    protected function getCurrentMatriculaId()
    {
        ...
        if (!is_null($this->_currentMatriculaId)) {
            ...
            throw new CoreExtensionException('Não foi possivel recuperar o id da Matricula atual.');
        }
    ...
    protected function serviceBoletim($reload = false)
    {
        ...
        if (is_null($this->_boletimServiceInstances[$matriculaId])) {
            throw new CoreExtensionException("Não foi possivel instanciar o serviço boletim para a Matricula $matriculaId.");
        }
