...
trait Avaliacao_Service_Boletim_Acessores
{
     ...
     * @return $this
     *
     * @throws CoreExtension_Service_Exception
     *@see CoreExtConfigurable::setOptions()
     *
     */
    public function setOptions(array $options = [])
    {
        if (!isset($options['Matricula'])) {
            require_once 'CoreExt/Service/CoreExtensionException.php';
            throw new CoreExtension_Service_Exception('É necessário informar o número de matrícula do aluno.');
        }
        ...
        if (is_null($this->_parecerDescritivoAbstractDataMapper)) {
            switch ($this->getRegraAvaliacaoTipoParecerDescritivo()) {
                ...
                case RegraAvaliacao_Model_TipoParecerDescritivo::ETAPA_GERAL:
                    ...
                    $class = 'ParecerDescritivoGeralDataMapper';
                    break;
                ...
                case RegraAvaliacao_Model_TipoParecerDescritivo::ETAPA_COMPONENTE:
                    ...
                    $class = 'ParecerDescritivoComponenteDataMapper';
                    break;
            }
