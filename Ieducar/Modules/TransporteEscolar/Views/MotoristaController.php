...
class MotoristaController extends EditController
{
    ...
    public function Gerar()
    {
        ...
        $options = [
            ...
            'max_length' => 15,
            'size' => 15,
            'placeholder' => Utils::toLatin1('Número da CNH'),
            'required' => false
        ];
        ...
        // Vencimento
        $options = [
            'label' => Utils::toLatin1($this->_getLabel('dt_habilitacao')),
            'required' => false,
            'size' => 10,
            'placeholder' => ''
        ];
        ...
        // Habilitação
        $options = [
            'label' => Utils::toLatin1($this->_getLabel('vencimento_cnh')),
            'required' => false,
            'size' => 10,
            'placeholder' => ''
        ];
        ...
        // Codigo da empresa
        $options = [
            'label' => Utils::toLatin1($this->_getLabel('ref_cod_empresa_transporte_escolar')),
            'required' => true
        ];
