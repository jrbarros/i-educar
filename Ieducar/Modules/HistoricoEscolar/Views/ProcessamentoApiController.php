...
class ProcessamentoApiController extends CoreControllerPageEditController
{
    ...
    {
        $historicoDisciplinas = new HistoricoDisciplinas();
    ...
    {
        $historicoDisciplina = new HistoricoDisciplinas(
            $fields['sequencial'],
            $fields['alunoId'],
    ...
    protected function recreateHistoricoDisciplinas($historicoSequencial, $alunoId, $turmaId = null)
    {
        ...
        if ($this->getRequest()->disciplinas == 'buscar-boletim') {
            ...
            foreach ($this->getService()->getComponentes() as $componenteCurricular) {
                ...
                if (Turma::verificaDisciplinaDispensada($turmaId, $ccId)) {
    ...
    {
        $sequencial = $this->getNextHistoricoDisciplinasSequencial($historicoSequencial, $alunoId);
        $historicoEscolar = new HistoricoEscolar($alunoId, $historicoSequencial);
