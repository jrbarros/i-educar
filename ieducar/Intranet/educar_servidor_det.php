...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        $tmp_obj = new Servidor($this->cod_servidor, null, null, null, null, null, null, $this->ref_cod_instituicao);
        ...
        // Escolaridade
        $obj_ref_idesco = new CadastroEscolaridade($registro['ref_idesco']);
        $det_ref_idesco = $obj_ref_idesco->detalhe();
        $registro['ref_idesco'] = $det_ref_idesco['descricao'];

        // Função
        $obj_ref_cod_funcao = new Funcao($registro['ref_cod_funcao'], null, null, null, null, null, null, null, null, $this->ref_cod_instituicao);
        ...
        $obj_cod_servidor      = new PessoaFisica($registro['cod_servidor']);
        $det_cod_servidor      = $obj_cod_servidor->detalhe();
        ...
        if ($lista) {
            ...
            foreach ($lista as $campo => $val) {
                ...
                $obj_escola = new Escola($val['ref_cod_escola']);
        ...
        if ($registro['ref_cod_subnivel']) {
            $obj_nivel = new Subnivel($registro['ref_cod_subnivel']);
          ...
          <tr>
            <td bgcolor=\'#ccdce6\' align=\'center\'>Cursos Ministrados</td>
                ...
                foreach ($lst_servidor_curso as $curso) {
                    $obj_curso = new Curso($curso['ref_cod_curso']);
      ...
      7  => 'Sábado'
        ...
        if ($obj_permissoes->permissao_cadastra(635, $this->pessoa_logada, 7)) {
            ...
            $obj_servidor_alocacao = new ServidorAlocacao();
          ...
          1
            ...
            $obj_afastamento = new ServidorAfastamento();
