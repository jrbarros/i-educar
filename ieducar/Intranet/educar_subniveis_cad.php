...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->ref_cod_categoria) && is_numeric($this->ref_cod_nivel)) {
            ...
            if ($lst_nivel_categoria) {
                ...
                $obj = new CategoriaNivel($this->ref_cod_categoria);
    ...
    public function Novo()
    {
        ...
        if ($this->nm_nivel) {
            ...
            foreach ($this->nm_nivel as $id => $nm_nivel) {
                $obj_nivel = new Subnivel($this->cod_nivel[$id], $this->pessoa_logada, $this->pessoa_logada, $nivel_anterior, $this->ref_cod_nivel, $nm_nivel, null, null, 1, str_replace(',', '.', str_replace('.', '', $this->salario_base[$id])));
                if ($obj_nivel->existe()) {
                    $obj_nivel->edita();
    ...
    public function Excluir()
    {
        ...
        $obj = new Subnivel($this->cod_nivel, $this->pessoa_logada, $this->pessoa_logada);
