...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        if ($det_mat_turma) {
            ...
            $obj_turma = new Turma($det_mat_turma['ref_cod_turma']);
        ...
        // Tipo da turma
        $obj_ref_cod_turma_tipo = new TurmaTipo($registro['ref_cod_turma_tipo']);
        ...
        $objTemp = new Turma($this->ref_cod_turma);
        ...
        $objEnturmacoes = new MatriculaTurma();
