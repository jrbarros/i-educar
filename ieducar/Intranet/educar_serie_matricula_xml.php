 ...
 */
function _getAnoEscolar(Banco $db, $sql)
{
    $db->Consulta($sql);
 ...
 * @return array (codSerie => nome)
 */
function _mesmoAnoEscolar(Banco $db, $codEscola, $codSerie)
{
    $sql = sprintf(
      'SELECT
      s.cod_serie,
 ...
 * @return array (codSerie => nome)
 */
function _anoEscolarSequencia(Banco $db, $codEscola, $codSerie)
{
    $sql = sprintf(
      'SELECT
      s.cod_serie,
 ...
 * @return array (codSerie => nome)
 */
function _anoEscolarEscolaCurso(Banco $db, $codEscola, $codCurso)
{
    $sql = sprintf(
      'SELECT
      s.cod_serie,
