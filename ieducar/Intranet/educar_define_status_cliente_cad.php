...
class indice extends clsCadastro
{
    ...
    public function Novo()
    {
        ...
        $obj = new ClienteSuspensao(null, $this->cod_cliente, $this->cod_motivo_suspensao, null, $this->pessoa_logada, $this->dias, null, null);
    ...
    public function Editar()
    {
        ...
        $obj_suspensao = new ClienteSuspensao($this->sequencial, $this->cod_cliente, null, $this->pessoa_logada, null, null, null, null);
        ...
        $obj = new Cliente($this->cod_cliente, $this->pessoa_logada, $this->pessoa_logada, $this->ref_idpes, $this->login, $senha, $this->data_cadastro, $this->data_exclusao, $this->ativo);
        $editou = $obj->edita();
    ...
    public function Excluir()
    {
        ...
        $obj = new Cliente($this->cod_cliente, $this->ref_cod_cliente_tipo, $this->pessoa_logada, $this->pessoa_logada, $this->ref_idpes, $this->login, $this->senha, $this->data_cadastro, $this->data_exclusao, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
