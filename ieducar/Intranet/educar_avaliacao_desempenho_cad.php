...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->sequencial) && is_numeric($this->ref_cod_servidor)) {
            $obj = new AvaliacaoDesempenho($this->sequencial, $this->ref_cod_servidor, $this->ref_ref_cod_instituicao);
    ...
    public function Gerar()
    {
        ...
        if ($nivel_usuario == 1) {
            $obj_instituicao = new Instituicao($this->ref_ref_cod_instituicao);
    ...
    public function Novo()
    {
        ...
        $obj = new AvaliacaoDesempenho(null, $this->ref_cod_servidor, $this->ref_ref_cod_instituicao, null, $this->pessoa_logada, $this->descricao, null, null, 1, $this->titulo_avaliacao);
    ...
    public function Editar()
    {
        ...
        $obj = new AvaliacaoDesempenho($this->sequencial, $this->ref_cod_servidor, $this->ref_ref_cod_instituicao, $this->pessoa_logada, null, $this->descricao, null, null, 1, $this->titulo_avaliacao);
        $editou = $obj->edita();
        if ($editou) {
    ...
    public function Excluir()
    {
        ...
        $obj = new AvaliacaoDesempenho($this->sequencial, $this->ref_cod_servidor, $this->ref_ref_cod_instituicao, $this->pessoa_logada, null, null, null, null, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
