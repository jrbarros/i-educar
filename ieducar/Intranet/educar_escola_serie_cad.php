...
class indice extends clsCadastro
{
    ...
    public function Excluir()
    {
        ...
        if ($excluiu) {
            $obj = new EscolaSerieDisciplina($this->ref_cod_serie_, $this->ref_cod_escola_, null, 0);
    ...
    private function getAnosLetivosDisponiveis()
    {
        ...
        if (is_numeric($this->ref_cod_escola) && is_numeric($this->ref_cod_curso)) {
            $objEscolaCurso = new EscolaCurso($this->ref_cod_escola, $this->ref_cod_curso);
