...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        $tmp_obj = new Usuario($this->cod_usuario);
        $registro = $tmp_obj->detalhe();

        $obj_ref_cod_tipo_usuario = new TipoUsuario($registro['ref_cod_tipo_usuario']);
        ...
        foreach ($escolasUsuario as $escola) {
            $escolaDetalhe = new Escola($escola['ref_cod_escola']);
