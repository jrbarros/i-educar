...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        $obj_tipo = new ClienteTipo($this->ref_cod_cliente_tipo);
        $det_tipo = $obj_tipo->detalhe();
        $obj_ref_cod_cliente = new Cliente();
        ...
        if ($lst_ref_cod_cliente) {
            foreach ($lst_ref_cod_cliente as $registro) {
                ...
                $obj_divida = new ExemplarEmprestimo();
                ...
                if ($lst_divida) {
                    ...
                    foreach ($lst_divida as $divida) {
                        ...
                        $obj_exemplar = new Exemplar($divida['ref_cod_exemplar']);
                        ...
                        if ($det_exemplar) {
                            ...
                            $obj_bib    = new Biblioteca($det_acervo['ref_cod_biblioteca']);
                    ...
                    $obj_multa  = new PagamentoMulta(null, null, $registro['cod_cliente'], null, null, $det_tipo['ref_cod_biblioteca']);
                    ...
                    $obj_tot = new ExemplarEmprestimo();
