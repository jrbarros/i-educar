...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_calendario_ano_letivo)) {
            $obj = new CalendarioAnoLetivo($this->cod_calendario_ano_letivo);
...
//      $this->campoData( "termino_ano_letivo", "Termino Ano Letivo", $this->termino_ano_letivo, true );
    ...
    public function Novo()
    {
        ...
        if ($data_inicio && $data_fim) {
            $obj_calend_ano_letivo = new CalendarioAnoLetivo();
            ...
            if ($lst_calend_ano_letivo) {
                ...
                $obj_calend_ano_letivo = new CalendarioAnoLetivo($det_calend_ano_letivo['cod_calendario_ano_letivo'], $this->ref_cod_escola, $this->pessoa_logada, null, $this->ano, null, null, 1/*, $data_inicio,$data_fim*/);
                ...
                $obj_calend_ano_letivo = new CalendarioAnoLetivo(null, $this->ref_cod_escola, null, $this->pessoa_logada, $this->ano, null, null, 1);
    ...
    public function Editar()
    {
        ...
        if ($data_inicio && $data_fim) {
            $obj_calend_ano_letivo = new CalendarioAnoLetivo($this->cod_calendario_ano_letivo, $this->ref_cod_escola, $this->pessoa_logada, null, $this->ano, null, null, 1/*, $data_inicio,$data_fim*/);
            if ($obj_calend_ano_letivo->edita()) {
                $this->mensagem .= 'Edi&ccedil;&atilde;o efetuada com sucesso.<br>';
                throw new HttpResponseException(
                    new RedirectResponse('educar_calendario_ano_letivo_lst.php')
    ...
    public function Excluir()
    {
        ...
        $obj = new CalendarioAnoLetivo($this->cod_calendario_ano_letivo, $this->ref_cod_escola, $this->pessoa_logada, $this->pessoa_logada, $this->ano, $this->data_cadastra, $this->data_exclusao, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
