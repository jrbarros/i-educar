...
require_once 'include/pmieducar/FuncionarioVinculo.php';
...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->ref_pessoa)) {
            ...
            $obj = new Usuario($this->ref_pessoa);
    ...
    public function Gerar()
    {
        ...
        $objFuncionarioVinculo = new FuncionarioVinculo;
    ...
    public function Novo()
    {
        ...
        if ($obj_funcionario->cadastra()) {
            if ($this->ref_cod_instituicao) {
                $obj = new Usuario($this->ref_pessoa, null, $this->ref_cod_instituicao, $this->pessoa_logada, $this->pessoa_logada, $this->ref_cod_tipo_usuario, null, null, 1);
            } else {
                $obj = new Usuario($this->ref_pessoa, null, null, $this->pessoa_logada, $this->pessoa_logada, $this->ref_cod_tipo_usuario, null, null, 1);
            }
    ...
    public function Editar()
    {
        ...
        if ($obj_funcionario->edita()) {
            ...
            if ($this->nivel_usuario_ == 8) {
                $obj_tipo = new TipoUsuario($this->ref_cod_tipo_usuario);
    ...
    {
        $usuarioEscola = new EscolaUsuario();
