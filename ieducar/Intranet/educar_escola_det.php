...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        $tmp_obj = new Escola($this->cod_escola);
        ...
        $obj_ref_cod_escola_rede_ensino = new EscolaRedeEnsino($registro['ref_cod_escola_rede_ensino']);
        ...
        if ($lst) {
            ...
            foreach ($lst as $valor) {
                ...
                $obj_curso = new Curso($valor['ref_cod_curso']);
    ...
    public function listaAnos()
    {
        ...
        if ($lista_ano_letivo) {
            ...
            foreach ($lista_ano_letivo as $ano) {
                ...
                $obj_matricula_ano = new Matricula();
