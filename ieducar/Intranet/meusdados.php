...
require_once 'include/RDStationAPI.php';
...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        $pessoaFisica = new PessoaFisica($this->pessoa_logada);
    ...
    public function Editar()
    {
        ...
        $usuario = new Usuario($this->pessoa_logada);
        $usuario = $usuario->detalhe();

        if ($usuario) {
            $instituicao = new Instituicao($usuario['ref_cod_instituicao']);
            $instituicao = $instituicao->detalhe();

            $instituicao = $instituicao['nm_instituicao'];

            $escola = new Escola($usuario['ref_cod_escola']);
