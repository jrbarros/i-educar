...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_modulo)) {
            $obj = new Modulo($this->cod_modulo);
    ...
    public function Novo()
    {
        ...
        $obj = new Modulo(null, null, $this->pessoa_logada, $this->nm_tipo, $this->descricao, $this->num_meses, $this->num_semanas, null, null, 1, $this->ref_cod_instituicao, $this->num_etapas);
    ...
    public function Editar()
    {
        ...
        $obj = new Modulo($this->cod_modulo, $this->pessoa_logada, null, $this->nm_tipo, $this->descricao, $this->num_meses, $this->num_semanas, null, null, 1, $this->ref_cod_instituicao, $this->num_etapas);
        $editou = $obj->edita();
        if ($editou) {
    ...
    public function Excluir()
    {
        ...
        $obj = new Modulo($this->cod_modulo, $this->pessoa_logada, null, null, null, null, null, null, null, 0);
        $modulo = $obj->detalhe();
    ...
    public function existeEtapaNaTurma()
    {
        ...
        $obj = new TurmaModulo($this->cod_modulo);
