...
class indice extends clsCadastro
{
    ...
    public function Gerar()
    {
        ...
        $obj_exemplar = new Exemplar($this->ref_cod_exemplar);
        ...
        if (is_array($lst_cliente_tipo_cliente) && count($lst_cliente_tipo_cliente)) {
            ...
            $obj_cliente_tipo_exemplar_tipo = new ClienteTipoExemplarTipo($cod_cliente_tipo, $cod_exemplar_tipo);
...
//      echo $this->cod_emprestimo." / ".$this->pessoa_logada." / ".date('Y-m-d')." / ".$this->valor_multa;die;
        ...
        $obj = new ExemplarEmprestimo($this->cod_emprestimo, $this->pessoa_logada, null, null, null, date('Y-m-d'), null, $this->valor_multa);
        $editou = $obj->edita();
        if ($editou) {
            $obj = new Exemplar($this->ref_cod_exemplar, null, null, null, $cod_situacao, $this->pessoa_logada, null, null, null, null, null, 1);
            $editou = $obj->edita();
            if (!$editou) {
