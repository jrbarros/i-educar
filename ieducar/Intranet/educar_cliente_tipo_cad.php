...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_cliente_tipo)) {
            $obj = new ClienteTipo($this->cod_cliente_tipo);
    ...
    public function Novo()
    {
        ...
        $obj = new ClienteTipo(null, $this->ref_cod_biblioteca, null, $this->pessoa_logada, $this->nm_tipo, $this->descricao, null, null, 1);
        ...
        if ($cadastrou) {
            ...
            if ($array_tipos) {
                foreach ($array_tipos as $exemplar_tipo => $dias_emprestimo) {
                    $obj = new ClienteTipoExemplarTipo($cadastrou, $exemplar_tipo, $dias_emprestimo);
    ...
    public function Editar()
    {
        ...
        $obj = new ClienteTipo($this->cod_cliente_tipo, $this->ref_cod_biblioteca, $this->pessoa_logada, null, $this->nm_tipo, $this->descricao, null, null, 1);
        $editou = $obj->edita();
        if ($editou) {
            //-----------------------EDITA EXEMPLAR TIPO------------------------//
            if ($array_tipos) {
                foreach ($array_tipos as $exemplar_tipo => $dias_emprestimo) {
                    $obj = new ClienteTipoExemplarTipo($this->cod_cliente_tipo, $exemplar_tipo, $dias_emprestimo);
    ...
    public function Excluir()
    {
        ...
        $obj = new ClienteTipo($this->cod_cliente_tipo, null, $this->pessoa_logada, null, null, null, null, null, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
