...
require_once('include/pmieducar/CategoriaAcervo.php');
...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        $obj_ref_cod_exemplar_tipo = new ExemplarTipo($registro['ref_cod_exemplar_tipo']);
        ...
        $obj_ref_cod_acervo_colecao = new AcervoColecao($registro['ref_cod_acervo_colecao']);
        ...
        $obj_ref_cod_acervo_idioma = new AcervoIdioma($registro['ref_cod_acervo_idioma']);
        ...
        if ($lst) {
            ...
            foreach ($lst as $valor) {
                ...
                $obj = new AcervoAutor($valor['ref_cod_acervo_autor']);
                $det = $obj->detalhe();
        ...
        $obj_categoria = new CategoriaAcervo();
