...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_falta_aluno)) {
            $obj = new FaltaAluno($this->cod_falta_aluno);
