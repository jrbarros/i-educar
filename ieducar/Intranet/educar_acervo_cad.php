...
require_once 'include/pmieducar/CategoriaObra.php';
...
class indice extends clsCadastro
{
    ...
    public function Excluir()
    {
        ...
        $excluiu = $obj->excluir();
        if ($excluiu) {
            $objCategoria = new CategoriaAcervo();
    ...
    {
        $objAutor = new AcervoAcervoAutor();
