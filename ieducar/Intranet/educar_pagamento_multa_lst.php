      ...
      'obrigatorio' => true
        ...
        if (is_array($lst_exemplar_emprestimo) && count($lst_exemplar_emprestimo)) {
            foreach ($lst_exemplar_emprestimo as $registro) {
                ...
                $obj_ex_em = new ExemplarEmprestimo();
                ...
                $obj_bib = new Biblioteca($registro['ref_cod_biblioteca']);
                $det_bib = $obj_bib->detalhe();
                if ($det_bib) {
                    $obj_inst = new Instituicao($det_bib['ref_cod_instituicao']);
                    $det_inst = $obj_inst->detalhe();
                    $obj_escola = new Escola($det_bib['ref_cod_escola']);
