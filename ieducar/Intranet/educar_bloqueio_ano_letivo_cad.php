...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->ref_cod_instituicao) && is_numeric($this->ref_ano)) {
            $obj = new BloqueioAnoLetivo($this->ref_cod_instituicao, $this->ref_ano);
    ...
    public function Novo()
    {
        ...
        $obj = new BloqueioAnoLetivo($this->ref_cod_instituicao, $this->ref_ano, dataToBanco($this->data_inicio), dataToBanco($this->data_fim));
