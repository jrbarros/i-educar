...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($cod_servidor_alocacao)) {
            ...
            $servidorAlocacao = new ServidorAlocacao($this->cod_servidor_alocacao);
    ...
    {
        $obj_inst = new Instituicao($this->ref_ref_cod_instituicao);
        ...
        if ($this->ref_cod_servidor) {
            $objTemp = new PessoaFisica($this->ref_cod_servidor);
    ...
    public function Novo()
    {
        ...
        if ($carga_horaria_disponivel >= $carga_horaria_alocada) {
            ...
            if ($this->cod_servidor_alocacao) {
                $obj_tmp = new ServidorAlocacao($this->cod_servidor_alocacao, null, $this->pessoa_logada);
                $obj_tmp->excluir();
            }
