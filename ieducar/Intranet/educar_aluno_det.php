...
require_once 'include/modules/FichaMedicaAluno.php';
require_once 'include/modules/MoradiaAluno.php';
require_once 'App/Model/ZonaLocalizacao.php';
require_once 'Educacenso/Model/AlunoDataMapper.php';
require_once 'Transporte/Model/AlunoDataMapper.php';
require_once 'include/pessoa/CadastroFisicaFoto.php';
...
class indice extends clsDetalhe
{
    ...
    public function Gerar()
    {
        ...
        $tmp_obj = new Aluno($this->cod_aluno);
        ...
        if ($this->ref_idpes) {
            ...
            $obj_deficiencia_pessoa = new CadastroFisicaDeficiencia();
            $obj_deficiencia_pessoa_lista = $obj_deficiencia_pessoa->lista($this->ref_idpes);

            $obj_beneficios = new AlunoBeneficio();
            ...
            $ObjDocumento = new Documento($this->ref_idpes);
        ...
        if ($registro['ref_cod_religiao']) {
            $obj_religiao = new Religiao($registro['ref_cod_religiao']);
        ...
        $objDistribuicaoUniforme = new DistribuicaoUniforme(null, $this->cod_aluno, date('Y'));
