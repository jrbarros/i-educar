...
//          $obj_notas_alunossss = new NotaAluno($nota_sozinha[count($nota_sozinha)-1], null, null, null, null, null, null, 184580);
//          if($obj_notas_alunossss->excluir())
//          {
//              $aprovado=1;
//              $obj_matricula = new Matricula($ref_cod_matricula);
//              $det_matricula = $obj_matricula->detalhe();
//              $ref_ref_cod_serie = $det_matricula["ref_ref_cod_serie"];
//              $ref_ref_cod_escola = $det_matricula["ref_ref_cod_escola"];
//              $obj_serie_disciplina = new EscolaSerieDisciplina();
...
//                  {
//                      /************************NOTAS********************/
//                      $obj_dispensa_disciplina = new DispensaDisciplina();
...
//                  }
//                  $obj_matricula_aux = new Matricula($ref_cod_matricula, null, null, null, 184580, null, null, $aprovado);
