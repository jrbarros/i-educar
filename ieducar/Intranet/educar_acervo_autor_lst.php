...
class indice extends clsListagem
{
    ...
    public function Gerar()
    {
        ...
        $obj_acervo_autor = new AcervoAutor();
        ...
        if (is_array($lista) && count($lista)) {
            foreach ($lista as $registro) {
                ...
                $obj_ref_cod_escola = new Escola($det_biblioteca['ref_cod_escola']);
                ...
                switch ($nivel_usuario) {
                    case 1:
                        ...
                        $obj_ref_cod_intituicao = new Instituicao($det_biblioteca['ref_cod_instituicao']);
