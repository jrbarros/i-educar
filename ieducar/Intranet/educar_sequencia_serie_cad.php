...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->ref_serie_origem) && is_numeric($this->ref_serie_destino)) {
            $obj = new SequenciaSerie($this->ref_serie_origem, $this->ref_serie_destino);
            $registro  = $obj->detalhe();
            if ($registro) {
                $obj_ref_serie_origem = new Serie($this->ref_serie_origem);
                $det_ref_serie_origem = $obj_ref_serie_origem->detalhe();
                $this->ref_curso_origem = $det_ref_serie_origem['ref_cod_curso'];
                $obj_ref_curso_origem = new Curso($this->ref_curso_origem);
                $det_ref_curso_origem = $obj_ref_curso_origem->detalhe();
                $this->ref_cod_instituicao = $det_ref_curso_origem['ref_cod_instituicao'];
                $obj_ref_serie_destino = new Serie($this->ref_serie_destino);
    ...
    public function Novo()
    {
        ...
        $obj_sequencia = new SequenciaSerie($this->ref_serie_origem, $this->ref_serie_destino);
        $det_sequencia = $obj_sequencia->detalhe();
        if (!$det_sequencia) {
            $obj = new SequenciaSerie($this->ref_serie_origem, $this->ref_serie_destino, null, $this->pessoa_logada, null, null, 1);
            ...
            $obj = new SequenciaSerie($this->ref_serie_origem, $this->ref_serie_destino, $this->pessoa_logada, null, null, null, 1);
            $editou = $obj->edita();
            if ($editou) {
    ...
    public function Editar()
    {
        ...
        //echo "SequenciaSerie($this->ref_serie_origem, $this->ref_serie_destino, $this->pessoa_logada, null, null, null, 1);";
        $obj = new SequenciaSerie($this->ref_serie_origem, $this->ref_serie_destino, $this->pessoa_logada, null, null, null, 1);
        $existe = $obj->existe();
        if (!$existe) {
    ...
    public function Excluir()
    {
        ...
        $obj = new SequenciaSerie($this->ref_serie_origem, $this->ref_serie_destino, $this->pessoa_logada, null, null, null, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
