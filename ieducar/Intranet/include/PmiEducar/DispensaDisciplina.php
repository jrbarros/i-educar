...
class DispensaDisciplina extends Model
{
    ...
    public function __construct(
        ...
        if (is_numeric($ref_usuario_exc)) {
            $usuario = new Usuario($ref_usuario_exc);
            if ($usuario->existe()) {
        ...
        if (is_numeric($ref_usuario_cad)) {
            $usuario = new Usuario($ref_usuario_cad);
            if ($usuario->existe()) {
        ...
        if (is_numeric($ref_cod_matricula)) {
            $matricula = new Matricula($ref_cod_matricula);
            if ($matricula->existe()) {
        ...
        if (is_numeric($ref_cod_tipo_dispensa)) {
            $tipoDispensa = new TipoDispensa($ref_cod_tipo_dispensa);
