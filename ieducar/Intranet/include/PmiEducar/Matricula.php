...
class Matricula extends Model
{
    ...
    public function setPessoaFalecido()
    {
        ...
        $matricula = new Matricula($this->cod_matricula);
        $matricula = $this->detalhe();

        $aluno = new Aluno($matricula['ref_cod_aluno']);
        $aluno = $aluno->detalhe();
    ...
    public function getTotalAlunosEscola(
        ...
        if (is_numeric($cod_escola) && is_numeric($cod_curso)) {
            ...
            $array_inicio_sequencias = Matricula::getInicioSequencia();
            $db = new Banco();
            ...
            foreach ($array_inicio_sequencias as $serie_inicio) {
                ...
                $obj_serie = new Serie($serie_destino);
