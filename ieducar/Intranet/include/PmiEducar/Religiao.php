...
class Religiao extends Model
{
    ...
    public function __construct($cod_religiao = null, $ref_usuario_exc = null, $ref_usuario_cad = null, $nm_religiao = null, $data_cadastro = null, $data_exclusao = null, $ativo = null)
    {
        $db = new Banco();
        $this->_schema = 'pmieducar.';
        $this->_tabela = "{$this->_schema}religiao";

        $this->_campos_lista = $this->_todos_campos = 'cod_religiao, ref_usuario_exc, ref_usuario_cad, nm_religiao, data_cadastro, data_exclusao, ativo';
