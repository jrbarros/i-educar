...
class EscolaDiasLetivos extends Model
{
    ...
    {
        if (is_numeric($this->ref_cod_escola) && is_numeric($this->ano) && is_numeric($this->ref_usuario_cad) && is_numeric($this->num_dias)) {
            $db = new Banco();
            ...
            if (is_numeric($this->num_dias)) {
                $campos .= "{$gruda}num_dias";
                $valores .= "{$gruda}'{$this->num_dias}'";
                $gruda = ', ';
            }
    ...
    public function edita()
    {
        if (is_numeric($this->ref_cod_escola) && is_numeric($this->ano) && is_numeric($this->ref_usuario_exc)) {
            ...
            if (is_numeric($this->num_dias)) {
                $set .= "{$gruda}num_dias = '{$this->num_dias}'";
                $gruda = ', ';
            }
