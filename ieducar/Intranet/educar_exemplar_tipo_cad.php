...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_exemplar_tipo)) {
            $obj = new ExemplarTipo($this->cod_exemplar_tipo);
    ...
    public function Novo()
    {
        ...
        $obj = new ExemplarTipo(null, $this->ref_cod_biblioteca, null, $this->pessoa_logada, $this->nm_tipo, $this->descricao, null, null, 1);
        ...
        if ($cadastrou) {
            ...
            if ($array_tipos) {
                foreach ($array_tipos as $cliente_tipo => $dias_emprestimo) {
                    $obj = new ClienteTipoExemplarTipo($cliente_tipo, $cadastrou, $dias_emprestimo);
    ...
    public function Editar()
    {
        ...
        $obj = new ExemplarTipo($this->cod_exemplar_tipo, $this->ref_cod_biblioteca, $this->pessoa_logada, null, $this->nm_tipo, $this->descricao, null, null, 1);
        $editou = $obj->edita();
        if ($editou) {
            //-----------------------EDITA CLIENTE TIPO------------------------//
            if ($array_tipos) {
                foreach ($array_tipos as $cliente_tipo => $dias_emprestimo) {
                    $obj = new ClienteTipoExemplarTipo($cliente_tipo, $this->cod_exemplar_tipo, $dias_emprestimo);
                    $editou2  = $obj->edita();
                    if (!$editou2) {
    ...
    public function Excluir()
    {
        ...
        $obj = new ExemplarTipo($this->cod_exemplar_tipo, null, $this->pessoa_logada, null, null, null, null, null, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
