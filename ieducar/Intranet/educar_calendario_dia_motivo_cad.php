...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_calendario_dia_motivo)) {
            $obj = new CalendarioDiaMotivo($this->cod_calendario_dia_motivo);
    ...
    public function Gerar()
    {
        ...
        if ($this->cod_calendario_dia_motivo) {
            $obj_calendario_dia_motivo = new CalendarioDiaMotivo($this->cod_calendario_dia_motivo);
    ...
    {
        $obj = new CalendarioDiaMotivo(null, $this->ref_cod_escola, null, $this->pessoa_logada, $this->sigla, $this->descricao, $this->tipo, null, null, 1, $this->nm_motivo);
    ...
    {
        $obj = new CalendarioDiaMotivo($this->cod_calendario_dia_motivo, $this->ref_cod_escola, $this->pessoa_logada, null, $this->sigla, $this->descricao, $this->tipo, null, null, 1, $this->nm_motivo);
        $editou = $obj->edita();
        if ($editou) {
    ...
    {
        $obj = new CalendarioDiaMotivo($this->cod_calendario_dia_motivo, null, $this->pessoa_logada, null, null, null, null, null, null, 0);
        $excluiu = $obj->excluir();
        if ($excluiu) {
