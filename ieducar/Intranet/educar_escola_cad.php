...
class indice extends clsCadastro
{
    ...
    public function Inicializar()
    {
        ...
        if (is_numeric($this->cod_escola) && !$_POST['passou']) {
            $obj = new Escola($this->cod_escola);
    ...
    public function Gerar()
    {
        ...
        if (!$this->sem_cnpj && !$this->com_cnpj) {
            ...
            if (is_numeric($this->cod_escola) && !$_POST) {
                $obj = new EscolaCurso($this->cod_escola);
            ...
            if ($this->cod_escola) {
                $objEscola = new Escola($this->cod_escola);
    ...
    public function Novo()
    {
        ...
        if ($this->com_cnpj) {
            ...
            if ($this->ref_idpes) {
                ...
                if ($cadastrou) {
                    $obj = new Escola(null, $this->pessoa_logada, null, $this->ref_cod_instituicao, $this->zona_localizacao, $this->ref_cod_escola_rede_ensino, $this->ref_idpes, $this->sigla, null, null, 1, null, $this->bloquear_lancamento_diario_anos_letivos_encerrados);
                    ...
                    if ($cadastrou1) {
                        ...
                        if ($this->escola_curso) {
                            foreach ($this->escola_curso as $campo) {
                                $curso_escola = new EscolaCurso($cadastrou1, $campo, null, $this->pessoa_logada, null, null, 1, $this->escola_curso_autorizacao[$campo], $this->escola_curso_anos_letivos[$campo]);
                        ...
                        $this->mensagem = 'Cadastro não realizado (Escola).<br>';
            ...
            $obj = new Escola(null, $this->pessoa_logada, null, $this->ref_cod_instituicao, $this->zona_localizacao, $this->ref_cod_escola_rede_ensino, null, $this->sigla, null, null, 1, null, $this->bloquear_lancamento_diario_anos_letivos_encerrados, $this->utiliza_regra_diferenciada);
            $obj->dependencia_administrativa = $this->dependencia_administrativa;
            $obj->orgao_vinculado_escola = $orgao_vinculado_escola;
            $obj->latitude = $this->latitude;
            $obj->longitude = $this->longitude;
            ...
            if ($cadastrou) {
                ...
                if ($this->escola_curso) {
                    foreach ($this->escola_curso as $campo) {
                        $curso_escola = new EscolaCurso($cadastrou, $campo, null, $this->pessoa_logada, null, null, 1, $this->escola_curso_autorizacao[$campo], $this->escola_curso_anos_letivos[$campo]);
                        $cadastrou_ = $curso_escola->cadastra();
    ...
    public function Editar()
    {
        ...
        if ($this->cod_escola) {
            $obj = new Escola($this->cod_escola, null, $this->pessoa_logada, $this->ref_cod_instituicao, $this->zona_localizacao, $this->ref_cod_escola_rede_ensino, $this->ref_idpes, $this->sigla, null, null, 1, $this->bloquear_lancamento_diario_anos_letivos_encerrados, $this->utiliza_regra_diferenciada);
            $obj->dependencia_administrativa = $this->dependencia_administrativa;
            $obj->orgao_vinculado_escola = $orgao_vinculado_escola;
            $obj->latitude = $this->latitude;
            $obj->longitude = $this->longitude;
            ...
            $obj = new Escola(null, $this->pessoa_logada, null, $this->ref_cod_instituicao, $this->zona_localizacao, $this->ref_cod_escola_rede_ensino, $this->ref_idpes, $this->sigla, null, null, 1, $this->bloquear_lancamento_diario_anos_letivos_encerrados, $this->utiliza_regra_diferenciada);
            $obj->situacao_funcionamento = $this->situacao_funcionamento;
            $obj->dependencia_administrativa = $this->dependencia_administrativa;
            $obj->orgao_vinculado_escola = $orgao_vinculado_escola;
            $obj->latitude = $this->latitude;
                ...
                if ($editou1) {
                    ...
                    if ($editou2) {
                        ...
                        if ($excluiu) {
                            if ($this->escola_curso) {
                                foreach ($this->escola_curso as $campo) {
                                    $obj = new EscolaCurso($this->cod_escola, $campo, null, $this->pessoa_logada, null, null, 1, $this->escola_curso_autorizacao[$campo], $this->escola_curso_anos_letivos[$campo]);
    ...
    public function Excluir()
    {
        $obj_permissoes = new Permissoes();
        $obj_permissoes->permissao_cadastra(561, $this->pessoa_logada, 3, 'educar_escola_lst.php');
        $obj = new Escola($this->cod_escola, null, $this->pessoa_logada, null, null, null, null, null, null, null, 0);
        $escola = $obj->detalhe();
        $excluiu = $obj->excluir();
