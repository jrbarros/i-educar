...
namespace iEducarLegacy\Intranet\Source\Pessoa;


class OrgaoEmissorRg
{
    public $idorg_rg;
    public $sigla;
    public $descricao;
    ...
    public function exclui()
    {
        if (is_numeric($this->idorg_rg)) {
            $objDocumento = new Documento(false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, $this->idorg_rg);
