...
class CoreView extends Base
{
     ...
     *
     * @var CoreControllerPageInterface
     */
     ...
     * @param  $instance
     */
    public function __construct(CoreControllerPageInterface $instance)
    {
        parent::__construct();
     ...
     *
     * @return CoreView Provê interface fluída
     */
